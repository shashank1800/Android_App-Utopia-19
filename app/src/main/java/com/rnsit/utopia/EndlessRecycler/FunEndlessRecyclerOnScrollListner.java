...
public abstract class FunEndlessRecyclerOnScrollListner extends RecyclerView.OnScrollListener{
    ...
    public FunEndlessRecyclerOnScrollListner(LinearLayoutManager linearLayoutManager) {
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (MainActivity.isScrollListenerEnabled && isScrolling && (firstVisibleItemPosition + visibleItemCount == totalItemCount) && !isLastItemReached) {
            ...
            Query nextQuery = db.collection("Fun")
